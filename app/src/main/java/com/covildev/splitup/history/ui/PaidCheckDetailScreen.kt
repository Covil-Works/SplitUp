...
import com.covildev.splitup.check.ui.CheckViewModeSelector
import com.covildev.splitup.check.ui.ExpandableItemCard
...
fun PaidCheckDetailScreen(
    ...
    if (uiState.showDeleteDialog) {
        AlertDialog(
            ...
            text = { Text("Essa aÃ§Ã£o Ã© irreversÃ­vel.") },
    ...
    if (uiState.showReopenDialog) {
        AlertDialog(
            ...
            text = { Text("A comanda voltarÃ¡ para a lista de abertas.") },
